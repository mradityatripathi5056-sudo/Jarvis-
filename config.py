...
# Mute state - speech.py mein bhi check hota hai (gui.py import nahi karta
# speech.py, circular-import se bachne ke liye) - isliye shared flag config
# mein rakha hai. MUTE button dabane pe Jarvis SUNTA bhi nahi aur BOLTA
# bhi nahi (pehle sirf sunna band hota tha, bolna nahi - ab dono).
IS_MUTED = False
...
# Pehle hardcoded 4000 tha. NOTE: "unlimited" possible nahi hai - har model/
# OpenRouter ki apni hard cap hoti hai (free models aksar 4096-16000 ke beech
# cap karte hain), itna bada number bhejoge jitna model allow hi nahi karta
# to wo request reject/ignore kar dega. Ye .env se badla ja sakta hai:
# MAX_TOKENS=16000 (jitna zyada, utna slow + free-tier rate-limit jaldi lagega).
